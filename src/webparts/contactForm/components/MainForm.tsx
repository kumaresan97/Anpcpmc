...
const MainForm = ({ context, apiurl }: any) => {
    ...
    const getProjectTypeOptions = async (): Promise<ProjectTypeOption[]> => {
        try {
            ...
            const items = await otherWeb.lists
                ...
                .items
                .filter("FieldName eq 'ProjectType'")
                .select("FieldValue")
                .get();
    ...
    const getAllContacts = async (): Promise<void> => {
        ...
        try {
            ...
            const contacts = await fetch(`${apiurl}/Contact/ListContactDetails?skip=0&take=10`, {
                method: "GET",
                headers: {
    ...
    const handleSubmit = async (): Promise<void> => {
        ...
        const typedMobile =
            formData.mobile?.length && formData.mobile[0].value
                ? formData.mobile[0].value.replace(formData.mobile[0].dialCode, "").trim()
                : "";
        ...
        try {
            const endpoint = `${apiurl}/Lead/AddLead`;
            ...
            let leadPayload = {
                ...
                serviceChoice: formData?.serviceChoice?.length ? JSON.stringify(formData.serviceChoice) : "",
                mobile: formData?.mobile?.length ? JSON.stringify(formData.mobile) : "",
    ...
    return loading ? <Loader /> : issubmitted ? <SuccessScreen></SuccessScreen> : (
        <div>
            <div
                    ...
                    <div className={styles.formBox}>
                        <div className={styles.form}>
                            ...
                            <div className={styles.formBody}>
                                ...
                                <div className={styles.row}>
                                    ...
                                    <div className={`${styles.phoneNumberInput} phoneNumberInput`}>
                                        ...
                                        <PhoneInput
                                            country={formData.mobile.length ? formData.mobile[0].countryCode : 'in'}
                                            ...
                                            onChange={(value: any, data: any) => {
                                                ...
                                                const phoneObject = [{
                                                    ...
                                                    // value: value || "",
                                                    value: formData?.mobile[0]?.countryCode === data?.countryCode
                                                        ? value : data?.dialCode?.toString() || ""
                                                }]
                                ...
                                <div className={styles.row}>
                                    ...
                                    <Input
                                        ...
                                        prefix={<MailOutlined style={{ color: '#d9d9d9', fontSize: "16px" }} />}
                                ...
                                <div className={styles.row}>
                                    ...
                                    <Input
                                        ...
                                        prefix={<InboxOutlined style={{ color: '#d9d9d9', fontSize: "20px" }} />}
                            ...
                            <div className={styles.formFooter}>
                                <Button onClick={handleSubmit} disabled={!isAccepted}>Submit</Button>
                            </div>
                        </div>
                    </div>
                </div>
